...
```{r PCA2,echo=FALSE,warning=FALSE,fig.width =9,fig.height=5, fig.align="center"}
...
One food that isn't represented in this analysis but serves as a fantastic beverage to use in smoothies is coconut water. It typically contains about 500mg of potassium (10% of RDI) per serving (i.e., more than a banana) and tastes delicious. Every day, I like to blend some coconut water, kale (10%), an avacodo (11%), and a banana (6%) with some ice to make a delcious smoothie to get me going. I also tend to add a scoop of a [plant-based coconut-almond protein powder](https://www.iherb.com/pr/vega-one-all-in-one-shake-coconut-almond-1-5-lbs-687-g/81577) (6%) from wholefoods into the mix and the result is just outstanding. Importantly though, a smoothie like this not only gets you to nearly 50% of the RDI for potassium, but also has so many other nutrients to cover your bases in those areas as well which is great. 
...
<ul> Most people don't get enough Potassium due to inadequate consumption of greens.
<ul> The recommended daily intake (RDI) for Potassium is 4700mg and a single banana has only 300mg.
<ul> Foods that are high in potassium also tend to be high in Magnesium, Iron, and Fiber. This is what makes vegetables so special.
<ul> Kale, Spinach, Avocados, and a variety of different nuts are a great source of these vital nutrients.
<ul> Be cautious of fruits and dates, they are loaded with sugar.
<ul> A smoothie blend consisting of coconut water, kale, an avocado, and a banana is a great way to get closer to the RDI.
