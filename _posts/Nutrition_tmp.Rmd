...
```{r HeatMap, echo=FALSE,fig.width =10,fig.height =11}
...
corrplot(cor.mat,
         ...
         rect.lwd = 4,
         cl.pos = "b", 
         tl.col="black", tl.srt=45, tl.cex=.6,cex.main=1,
...
par(mfrow=c(1,1))
pie(pie.dat$Freq,labels = pie.labs,radius = 1,col = opal,cex=0.5,main = "The Percentage of High-Potassium Items by Food Category",cex.main=1,mar=c(1,1,1,1))
#dev.off()
```
...
```{r Wordclouds, echo=FALSE,fig.width =10,fig.height =6,fig.align="center"}
...
```{r PCA,echo=FALSE,fig.width =10,fig.height=5, fig.align="center"}
